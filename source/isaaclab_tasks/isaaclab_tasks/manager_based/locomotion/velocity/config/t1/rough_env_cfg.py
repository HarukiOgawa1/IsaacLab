...
class T1Rewards(RewardsCfg):
    ...
    joint_deviation_hip = RewTerm(
        ...
        weight=-0.1,
        params={"asset_cfg": SceneEntityCfg("robot", joint_names=[".*_Hip_Pitch", ".*_Hip_Roll", ".*_Hip_Yaw",])},
    )
...
class T1RoughEnvCfg(LocomotionVelocityRoughEnvCfg):
    ...
    def __post_init__(self):
        ...
        # terminations
        self.terminations.base_contact.params["sensor_cfg"].body_names = ["Trunk", "H2", ".*_hand_link"]
